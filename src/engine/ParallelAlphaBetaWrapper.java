...
public class ParallelAlphaBetaWrapper implements Runnable {
	 ...
	 * werden sollen.
	 */
	public void setAlphaBetaRunParams(AlphaBeta alphaBeta, Move move,
			Bitboard board, int depth, boolean maximizingPlayer, int alpha,
	...
	public LinkedList<Move> runAlphaBetaNotParallel() {
		...
		return resultList = alphaBeta.alphaBeta(board, depth, maximizingPlayer,
				alpha, beta, useMemory, moveOrdering, normalSearch,
	...
	public void run() {
		...
		/* Parallele Suche */
		resultList = alphaBeta.alphaBeta(board, depth, maximizingPlayer, alpha,
				beta, useMemory, moveOrdering, normalSearch, maxSearchDepth,
				isQuiescence, false, isExtended);
